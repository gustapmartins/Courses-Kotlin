...
class TopicoServiceTest {
    ...
    fun `Deve me retornar todos os topicos`() {
        ...
        assertEquals(TopicoViewTest.build(), result[0])
    ...
    fun `Deve me retornar o topico especifico`() {
        ...
        // Assert
        assertEquals(TopicoViewTest.build(), result)
    ...
    fun `Deve criar um novo Topico`() {
        ...
        // Assert
        assertEquals(TopicoTest.buildDto(), result)
...
//
//        val updatedTopico = TopicoTest.build().copy(titulo = update.titulo ?: topico.titulo, mensagem = update.mensagem ?: topico.mensagem, dataAlteracao = topico.dataAlteracao)
//
//        every { repository.findById(TopicoTest.build().id) } returns Optional.of(TopicoTest.build())
